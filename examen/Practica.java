public class Practica{
	...
	public static void main(String[] args) {
		...
		cliente[3] = new Cliente("Joselito Sanchez", "jos12", "Ciztapalapa", 100.0);
		cliente[4] = new Cliente("Gustavito gutierrez", "gus69", "ciruelos #20", 1501.0);
		while(true){
			...
			if(indiceCliente != -1) {
				while(true){
					...
					if(opcion.equals("1")){
						...
						ventana.transferirSaldo(cliente[indiceCliente], cliente);
					}
					else if(opcion.equals("5")){
						ventana.verHistorial(cliente[indiceCliente]);
					}
